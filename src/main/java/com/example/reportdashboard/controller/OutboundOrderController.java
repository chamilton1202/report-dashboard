...
public class OutboundOrderController {
	...
	public String getOutboundOrders(Model model, HttpSession session) {
		...
		List<OutboundOrder> outboundOrdersList = (List<OutboundOrder>) session.getAttribute("sessionOutboundOrdersList");
	...
	@RequestMapping(value = "/DownloadOutboundOrdersReport", method = RequestMethod.POST, produces = MediaType.APPLICATION_PDF_VALUE)
	public Object downloadOutboundOrdersReport(HttpSession session) {
		log.info("Entered downloadOutboundOrdersReport()");
		// Get the OutboundOrders List from the Session Attribute saved by the Search
