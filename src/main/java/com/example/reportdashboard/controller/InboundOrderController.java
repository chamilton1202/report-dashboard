...
public class InboundOrderController {
	...
	public String searchInboundOrders(@ModelAttribute OrderSearch orderSearch, BindingResult result, 
		...
		List<InboundOrder> sessionInboundOrdersList = inboundOrderService.findByFromDateAndToDate(orderSearch.getFromDate(), orderSearch.getToDate());
	...
	@RequestMapping(value = "/DownloadInboundOrdersReport", method = RequestMethod.POST,
            produces = MediaType.APPLICATION_PDF_VALUE)
    public Object downloadInboundOrdersReport(HttpSession session) {
		log.info("Entered downloadInboundOrdersReport()");
		//Get the InboundOrders List from the Session Attribute saved by the Search
