...
public class GenerateOutboundOrderPDF {

	private static final Logger logger = LoggerFactory.getLogger(GenerateOutboundOrderPDF.class);
...
public static ByteArrayInputStream outboundOrderReport(List<OutboundOrder> outboundOrderList) {
		...
		try {
            ...
            for (OutboundOrder outboundOrder : outboundOrderList) {
                ...
                //OrderId field
                cell = new PdfPCell(new Phrase(outboundOrder.getOrderId(), tableFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                table.addCell(cell);
                
                //CreatedDate field
                cell = new PdfPCell(new Phrase(outboundOrder.getCreatedDate().toString(), tableFont));
                ...
                //Type field
                cell = new PdfPCell(new Phrase(outboundOrder.getType(), tableFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                //CPU field
                cell = new PdfPCell(new Phrase(outboundOrder.getCpu(), tableFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                //cell.setPaddingRight(5);
                table.addCell(cell);
                ...
                //Status field
                cell = new PdfPCell(new Phrase(outboundOrder.getStatus(), tableFont));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                //cell.setPaddingRight(5);
                table.addCell(cell);
            ...
            //Add Title
            document.add(new Paragraph("Outbound Orders Report", titleFont));
            //Add Paragraph
            document.add(new Paragraph(" "));
            //Add Paragraph
